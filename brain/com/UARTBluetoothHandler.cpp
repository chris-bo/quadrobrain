...
UARTBluetoothHandler::UARTBluetoothHandler(Status* statusPtr, uint8_t defaultPrio,
		DiscoveryLEDs* _ledctrl, Led_TypeDef _led, UART_HandleTypeDef* huart) :
		...
		initializeBuffers(UartRXbuf, UartTXbuf, &uart_bytes_received, UART_RXTX_BUFF_SIZE);
}
