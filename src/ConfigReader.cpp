...
void ConfigReader::load( uint8_t* variable, uint16_t address, uint16_t byteCount ) {
	...
	HAL_I2C_Mem_Read( eeprom_i2c, EEPROM_ADDRESS, address, I2C_MEMADD_SIZE_16BIT, variable, byteCount, EEPROM_I2C_TIMEOUT );
}
...
void ConfigReader::save( uint8_t* variable, uint16_t address, uint16_t byteCount ) {
	...
	HAL_I2C_Mem_Write( eeprom_i2c, EEPROM_ADDRESS, address, I2C_MEMADD_SIZE_16BIT, variable, byteCount, EEPROM_I2C_TIMEOUT );
}
